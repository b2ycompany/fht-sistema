        ...
        <Card className="border-l-4 border-yellow-500">
            ...
            <CardContent className="space-y-3 text-sm">
                ...
                <div className="pt-3 border-t mt-3">
                    <p className="font-semibold text-green-600">Seu Valor Desejado: {formatCurrency(match.doctorDesiredRate)}/h</p>
                    <p className="text-xs text-gray-500 mt-1">O administrador está a analisar esta proposta. Por favor, aguarde o contato no chat abaixo para negociar.</p>
                </div>
            </CardContent>
