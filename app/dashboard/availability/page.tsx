  ...
  const handleSubmit = async () => {
    ...
    try {
      if (isEditing && initialData?.id) {
        const payload: TimeSlotUpdatePayload = { startTime, endTime, isOvernight, state: selectedState, cities: selectedCities, serviceType: selectedServiceType, specialties: selectedSpecialties, desiredHourlyRate, ...(finalNotes && { notes: finalNotes }) };
        ...
        const creationPromises = dates.map(singleDate => {
          ...
          const payload: TimeSlotFormPayload = { date: slotTimestamp, startTime, endTime, isOvernight, state: selectedState, cities: selectedCities, serviceType: selectedServiceType, specialties: selectedSpecialties, desiredHourlyRate, ...(finalNotes && { notes: finalNotes }) };
