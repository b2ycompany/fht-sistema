                ...
                <Tabs defaultValue="medical-record" className="flex-grow flex flex-col">
                    ...
                    <TabsContent value="patient-data" className="text-sm space-y-4 mt-4 flex-grow">
                        ...
                        <Dialog open={isHistoryModalOpen} onOpenChange={setIsHistoryModalOpen}>
                            <DialogTrigger asChild><Button variant="secondary"><History className="mr-2 h-4 w-4" />Ver Histórico de Consultas</Button></DialogTrigger>
                            <PatientHistoryDialog patientId={consultation.patientId} currentConsultationId={consultation.id} />
                        </Dialog>
                    </TabsContent>
        ...
        <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-3 gap-6 h-[calc(100vh-120px)]">
                ...
                <div className="h-full flex flex-col gap-6">
                    {consultation.type === 'Telemedicina' && ( <Card className="border-blue-500 border-2"><CardHeader><CardTitle className="flex items-center gap-2"><Video />Sala de Telemedicina</CardTitle></CardHeader><CardContent>{consultation.telemedicineLink ? (<Button asChild className="w-full bg-blue-600 hover:bg-blue-700"><Link href={consultation.telemedicineLink} target="_blank" rel="noopener noreferrer">Entrar na Chamada de Vídeo</Link></Button>) : (<p className="text-sm text-muted-foreground text-center">A sala de vídeo está a ser criada...</p>)}</CardContent></Card> )}
