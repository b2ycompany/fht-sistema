              ...
              {[
                {
                  ...
                  desc: "Adicione suas especialidades e documentos de forma simples.",
                },
                {
                  icon: <Calendar className="h-8 w-8 text-blue-600" />,
                  title: "Defina sua agenda",
                  desc: "Escolha os dias e horários em que está disponível.",
                },
                {
                  icon: <Clock className="h-8 w-8 text-blue-600" />,
                  title: "Receba propostas",
                  desc: "Hospitais enviam ofertas baseadas no seu perfil.",
                },
                {
                  icon: <FileText className="h-8 w-8 text-blue-600" />,
                  title: "Assine digitalmente",
                  desc: "Contrato seguro e digital, com validade jurídica.",
                },
